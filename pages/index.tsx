...
export default function Home(props: {
  ...
  return (
    <>
      <Head>
        <title>aaaaaaaaaaaaaaaaaaaaaaaa</title> {/* !change */}
      ...
      <section className="min-h-screen p-4 bg-contain bg-hero-pattern">
        ...
        >
          ...
          >
            <h1 className="text-center md:text-6xl text-3xl md:font-black font-bold">HackAZ</h1>{' '}
            {/* !change */}
            <p className="text-center my-4 md:font-bold md:text-3xl text-xl">
              {' '}
              {/* !change */}A hackathon by UOFA students
            </p>
          </div>
      ...
      */
      ...
      <section className="md:p-12 p-6">
        <h1 className="md:text-4xl text-2xl font-bold my-4">About HackAZ</h1> {/* !change */}
        <div className="md:text-base text-sm">
          HackAZ has been out of the running for a few years .
        </div>
      </section>
